...
export const LandingPage: React.FC = () => {
  const apkDownloadUrl =
    "https://pub-8450631443cd4ea7978907598a15212e.r2.dev/app-release.apk";
  ...
  const pillars = [
    {
      ...
      headline:
        "Smart check-ins that protect you without unlocking your phone.",
  ...
  const testimonials = [
    {
      quote:
        "Safety gives me total peace of mind walking home from late shifts. The automated check-in means I never have to worry.",
      name: "Amina Vance",
    ...
    {
      quote:
        "One tap connects me to my emergency contacts with my exact location. It feels like having a personal guardian with me.",
      name: "David Mensah",
    ...
    {
      quote:
        "As a university student walking across campus at night, having proactive protection running in the background is a game changer.",
      name: "Sophia Jenkins",
      ...
      >
        ...
        <div>
          ...
          <h1 className="display-mega" style={{ marginBottom: "1.25rem" }}>
            Never Walk Alone.
            <br />
            <span className="accent-italic">Smart Protection</span> for Every
            Journey.
          </h1>
          ...
          >
            Safety watches over you while you walk. Automatic check-ins, instant
            emergency alerts to loved ones, and direct help whenever you need
            it.
          </p>
          ...
          >
            ...
            <a href="#features" className="btn-oneforma-ghost">
          ...
          >
            ...
            <div
              style={{
                flex: 1,
                background:
                  "radial-gradient(circle at center, #F0FDF4 0%, #FFFFFF 85%)",
                position: "relative",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
            ...
            >
              ...
              <span style={{ color: "var(--accent-green-dark)" }}>
                Status: Safe
              </span>
            </div>
          </div>
      ...
      >
        ...
        >
          ...
          <div style={{ textAlign: "right" }}>
            ...
            >
              Real experiences from everyday walkers, students, and commuters
              who rely on Safety for peace of mind.
            </p>
          </div>
        </div>
            ...
            >
              <div>
                ...
                >
                  ...
                  <Quote
                    size={20}
                    color="var(--accent-green-border-subtle)"
                    style={{ opacity: 0.8 }}
                  />
                </div>
        ...
        <div style={{ maxWidth: "1240px", margin: "0 auto" }}>
          ...
          >
            ...
            <div style={{ textAlign: "right" }}>
              ...
              >
                Engineered to keep you secure and connected without intruding on
                your daily walk.
              </p>
              <a
                href="#download"
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                transition:
                  "opacity 0.2s cubic-bezier(0.4, 0, 0.2, 1), transform 0.2s cubic-bezier(0.4, 0, 0.2, 1), filter 0.2s cubic-bezier(0.4, 0, 0.2, 1)",
              }}
            >
              <div>
        ...
        >
          <div>
            ...
            <p className="lede" style={{ marginBottom: "2rem" }}>
              Protect yourself and loved ones on every walk. Equipped with
              background check-ins, instant SOS alerts, emergency siren, and
        ...
        <div style={{ maxWidth: "1240px", margin: "0 auto" }}>
          ...
          >
            ...
            <div>
              ...
              >
                Personal safety and proactive protection for every journey. Live
                tracking, automatic check-ins, and instant emergency alerts.
              </p>
            </div>
            ...
            <div>
              ...
              >
                ...
                <li>
                  <span>Anonymous Safety Reporting</span>
                </li>
                <li>
                  <span>Private Location Data</span>
                </li>
                <li>
                  <span>No Tracking when Inactive</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          >
            <div>
              &copy; {new Date().getFullYear()} Safety Operations Network. All
              rights reserved.
            </div>
            <div>OSF x ANDELA Hackaton</div>
            <div>Personal Safety & Protection.</div>
          </div>
        </div>
      </footer>
    </div>
