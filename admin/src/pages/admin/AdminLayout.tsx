...
import { Radio, FileText, Users, LogOut, Search } from "lucide-react";
    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="admin-header-title" style={{ minWidth: "180px" }}>
            <h1
              style={{
                fontSize: "1.25rem",
                fontWeight: 800,
          ...
          {/* Right: Symmetrical Balancer + Mobile Logout */}
          <div
            className="admin-header-right-spacer"
            style={{
              minWidth: "180px",
              display: "flex",
          ...
          >
            ...
            <button
              onClick={handleLogout}
              className="btn btn-outline admin-mobile-logout"
              style={{
                padding: "0.45rem 0.55rem",
                borderRadius: "var(--radius-sm)",
                flexShrink: 0,
