...
export const StaffPage: React.FC = () => {
  const { staffMembers, addStaffMember, deleteStaffMember, globalSearch } =
    useData();
  ...
  const filteredStaff = useMemo(() => {
    return staffMembers.filter((staff) => {
      if (
        countryFilter !== "all" &&
        (staff.countryCode || "ALL") !== countryFilter
      )
        return false;
  ...
  const stats = useMemo(() => {
    ...
    const uniqueCountries = new Set(
      staffMembers.map((s) => s.countryCode || "ALL"),
    ).size;
                ...
                >
                  ...
                  >
                    ...
                    <span style={{ fontSize: "0.78rem" }}>
                      Try clearing the search or changing the region filter
                      above.
                    </span>
                  </div>
                </td>
                      ...
                      >
                        <div
                          style={{
                            ...
                            color: "var(--accent-green-dark)",
                            border:
                              "1.5px solid var(--accent-green-border-subtle)",
                            display: "flex",
                            alignItems: "center",
                            justifyContent: "center",
                            fontWeight: 800,
