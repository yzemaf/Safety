    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at 20% 20%, #FFFFFF 0%, #F0FDF4 65%, #DCFCE7 100%)",
            ...
            >
              ...
              <div
                style={{
                  ...
                  animation:
                    "pulseRing 3s cubic-bezier(0.2, 0.8, 0.2, 1) infinite",
                }}
              />
            </div>
        ...
        >
          ...
          <div style={{ maxWidth: "420px", width: "100%", margin: "0 auto" }}>
            <div style={{ marginBottom: "1.75rem" }}>
              ...
              >
                Enter your administrator credentials to access the safety
                platform dashboard.
              </p>
            </div>
